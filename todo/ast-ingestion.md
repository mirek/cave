...
- AST module analysis: https://github.com/mirek/ast/pull/30 at `bda94b2`.
  All sixteen review findings have fixes, public regressions, replies and
...
- Workspace workflow: https://github.com/mirek/cave/pull/249, stacked on
  ...
  Both CI runtime refs and the example README now target `bda94b2`.
...
- Cave self-ingestion at `cfb24b6` produces 3,957 unchanged records: zero mapped,
  ...
  were verified. The latest upstream change only preserves source names for
  unresolved export aliases.
...
sub-checkouts. Latest logs: `ast-unresolved-alias-check.log`,
`ast-unresolved-alias-build.log`, `workspace-local-binding-runtime.log`, and
