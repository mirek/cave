...
- AST module analysis: https://github.com/mirek/ast/pull/30 at `d64b9bb`.
  All seventeen review findings have fixes, public regressions, replies and
...
- Workspace workflow: https://github.com/mirek/cave/pull/249, stacked on
  ...
  Both CI runtime refs and the example README now target `d64b9bb`.
...
- Cave self-ingestion at `cfb24b6` produces 3,957 unchanged records: zero mapped,
  ...
  were verified. The latest upstream change only classifies internal import-equals
  aliases using the cached checker in syntax-only mode.
...
sub-checkouts. Latest logs: `ast-internal-alias-check.log`,
`ast-internal-alias-build.log`, `workspace-local-binding-runtime.log`, and
