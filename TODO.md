...
- [Make read-only commands preserve the store's schema version](todo/read-only-command-databases.md) — Stop queries, reports, and diagnostics from migrating an older store in place.
