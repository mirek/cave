...
```ts
export declare const followed: (store: Store, name: string) => boolean;
```
...
- `@cavelang/cli/dist/internal/connect/declared.d.ts` — `6822e1c6b3fddac800d3e6860a0dff021ab810aaf1557be52058a04b33690f1b`
