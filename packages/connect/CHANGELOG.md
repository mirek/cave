...
- Align the @cavelang/connect workspace with the CAVE 0.37.1 release identity.

## 0.37.0

### Minor Changes

- Align the @cavelang/connect workspace with the CAVE 0.37.0 release identity.

## 0.36.10

### Patch Changes

- Align the @cavelang/connect workspace with the CAVE 0.36.10 release identity.
...
- Align the @cavelang/connect workspace with the CAVE 0.36.8 release identity.
