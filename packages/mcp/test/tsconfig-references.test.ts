...
test('release automation validates identity before npm and matches the supported runtime', () => {
  ...
  assert.match(release, /CAVE_NPM_VISIBILITY_ATTEMPTS:-8/)
  assert.match(release, /CAVE_NPM_VISIBILITY_RETRY_DELAY_SECONDS:-5/)
  assert.match(release, /delay \* 2 > 60 \? 60 : delay \* 2/)
