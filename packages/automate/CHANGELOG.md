...
- Align the @cavelang/automate workspace with the CAVE 0.37.1 release identity.
...
- Align the @cavelang/automate workspace with the CAVE 0.36.10 release identity.

## 0.36.9

### Patch Changes

- Align the @cavelang/automate workspace with the CAVE 0.36.9 release identity.

## 0.36.8

### Patch Changes

- Align the @cavelang/automate workspace with the CAVE 0.36.8 release identity.

## 0.36.7

### Patch Changes

- Align the @cavelang/automate workspace with the CAVE 0.36.7 release identity.

## 0.36.6

### Patch Changes

- Align the @cavelang/automate workspace with the CAVE 0.36.6 release identity.

## 0.36.5

### Patch Changes

- Align the @cavelang/automate workspace with the CAVE 0.36.5 release identity.

## 0.36.4

### Patch Changes

- Align the @cavelang/automate workspace with the CAVE 0.36.4 release identity.
